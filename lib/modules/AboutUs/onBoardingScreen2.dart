    ...
    return   SafeArea(
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: Padding(
            padding:  EdgeInsetsDirectional.symmetric(vertical:sizeConfig.defaultSize!* 8,horizontal: 20 ),
            child: Column (
              ...
              children: [
                Center(
                  child: Image.asset('./assets/clothesDonation.jpg',
...
//     path.moveTo(0, sizeConfig.defaultSize!*57);
//     path.lineTo(0, h);
//     // path.quadraticBezierTo(0, h, 50,h);
//     path.lineTo(w, h);
//     //  path.quadraticBezierTo(0, h, 50,h);
//     path.lineTo(w, sizeConfig.defaultSize!*59);
//    path.quadraticBezierTo(sizeConfig.defaultSize!*15, sizeConfig.defaultSize!*62, 0,sizeConfig.defaultSize!*57);
//
//
//     return path;
//   }
